package com.scriza.in.MoneyLiveTest.User.Entity;
...
public class User {
   ...
   @Column(unique = true)
    private String referralCode;  // The user's unique referral code

    @ManyToOne
    @JoinColumn(name = "referred_by")
    private User referredBy;  // The user who referred this user
// Autogenerated unique referral code (6 alphabets)
